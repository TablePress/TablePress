...
use Generator;
use TablePress\Matrix\Decomposition\LU;
use TablePress\Matrix\Decomposition\QR;

/**
 * TablePress\Matrix object.
 *
 * @package TablePress\Matrix
 *
 * @property-read int $rows The number of rows in the matrix
 * @property-read int $columns The number of columns in the matrix
 * @method TablePress\Matrix antidiagonal()
 * @method TablePress\Matrix adjoint()
 * @method TablePress\Matrix cofactors()
 * @method float determinant()
 * @method TablePress\Matrix diagonal()
 * @method TablePress\Matrix identity()
 * @method TablePress\Matrix inverse()
 * @method TablePress\Matrix minors()
 * @method float trace()
 * @method TablePress\Matrix transpose()
 * @method TablePress\Matrix add(...$matrices)
 * @method TablePress\Matrix subtract(...$matrices)
 * @method TablePress\Matrix multiply(...$matrices)
 * @method TablePress\Matrix divideby(...$matrices)
 * @method TablePress\Matrix divideinto(...$matrices)
 * @method TablePress\Matrix directsum(...$matrices)
 */
class Matrix
{
	protected $rows;
	...
	/*
	 * Create a new TablePress\Matrix object from an array of values
	 *
	 * @param array $grid
	 */
	 ...
	 * @throws Exception
	 */
	public function getRows(int $row, int $rowCount = 1): TablePress\Matrix
	{
	 ...
	 * @throws Exception
	 */
	public function getColumns(int $column, int $columnCount = 1): TablePress\Matrix
	{
	 ...
	 * @throws Exception
	 */
	public function dropRows(int $row, int $rowCount = 1): TablePress\Matrix
	{
	 ...
	 * @throws Exception
	 */
	public function dropColumns(int $column, int $columnCount = 1): TablePress\Matrix
	{
	 ...
	 * Solve A*X = B.
	 *
	 * @param TablePress\Matrix $B Right hand side
	 *
	 * @throws Exception
	 *
	 * @return TablePress\Matrix ... Solution if A is square, least squares solution otherwise
	 */
	 ...
	 * @return TablePress\Matrix|float
	 * @throws Exception
	 */
