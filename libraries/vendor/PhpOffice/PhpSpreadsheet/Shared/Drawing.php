...
class Drawing
{
	 ...
	 */
	public static function pixelsToEMU(int $pixelValue)
	{
	 ...
	 */
	public static function pixelsToCellDimension(int $pixelValue, \TablePress\PhpOffice\PhpSpreadsheet\Style\Font $defaultFont)
	{
		// Font name and size
	 ...
	 * @param \TablePress\PhpOffice\PhpSpreadsheet\Style\Font $defaultFont Default font of the workbook
	 *
	 * @return int Value in pixels
	 */
	public static function cellDimensionToPixels(float $cellWidth, \TablePress\PhpOffice\PhpSpreadsheet\Style\Font $defaultFont): int
	{
		// Font name and size
		$name = $defaultFont->getName();
		$size = $defaultFont->getSize();
