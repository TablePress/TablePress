...
use TablePress\Matrix\Builder;
use TablePress\Matrix\Div0Exception as MatrixDiv0Exception;
use TablePress\Matrix\Exception as MatrixException;
...
class MatrixFunctions
{
	 ...
	 */
	private static function getMatrix($matrixValues): TablePress\Matrix
	{
		$matrixData = [];
	...
	public static function inverse($matrixValues)
	{
		...
		} catch (MatrixDiv0Exception $exception) {
