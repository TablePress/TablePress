...
class Font extends Supervisor
{
	 ...
	 *         'bold' => TRUE,
	 *         'italic' => FALSE,
	 *         'underline' => \TablePress\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLE,
	 *         'strikethrough' => FALSE,
	 *         'color' => [
	 *             'rgb' => '808080'
	 *         ]
	 ...
	 * Set Underline.
	 *
	 * @param bool|string $underlineStyle \TablePress\PhpOffice\PhpSpreadsheet\Style\Font underline type
	 ...
	 * @return $this
	 */
	public function setStrikethrough(bool $strikethru)
	{
		if ($strikethru == '') {
			$strikethru = false;
		}
