...
namespace TablePress\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter;

use TablePress\PhpOffice\PhpSpreadsheet\Exception as PhpSpreadsheetException;
use TablePress\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter;
...
class Column
{
	 ...
	 * @return $this
	 */
	public function setColumnIndex(string $column)
	{
