...
use TablePress\PhpOffice\PhpSpreadsheet\Worksheet\Drawing\Shadow;
...
class BaseDrawing implements IComparable
{
	...
	public function setWorksheet(?Worksheet $worksheet = null, bool $overrideOld = false): self
	{
		if ($this->worksheet === null) {
			// Add drawing to \TablePress\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet
			if ($worksheet !== null) {
			...
			if ($overrideOld) {
				// Remove drawing from old \TablePress\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet
				...
				// Set new \TablePress\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet
