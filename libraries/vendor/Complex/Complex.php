...
/**
 *
 * Class for the management of TablePress\Complex numbers
 *
...
/**
 * TablePress\Complex Number object.
 *
 * @package TablePress\Complex
 *
 * @method float abs()
 * @method TablePress\Complex acos()
 * @method TablePress\Complex acosh()
 * @method TablePress\Complex acot()
 * @method TablePress\Complex acoth()
 * @method TablePress\Complex acsc()
 * @method TablePress\Complex acsch()
 * @method float argument()
 * @method TablePress\Complex asec()
 * @method TablePress\Complex asech()
 * @method TablePress\Complex asin()
 * @method TablePress\Complex asinh()
 * @method TablePress\Complex atan()
 * @method TablePress\Complex atanh()
 * @method TablePress\Complex conjugate()
 * @method TablePress\Complex cos()
 * @method TablePress\Complex cosh()
 * @method TablePress\Complex cot()
 * @method TablePress\Complex coth()
 * @method TablePress\Complex csc()
 * @method TablePress\Complex csch()
 * @method TablePress\Complex exp()
 * @method TablePress\Complex inverse()
 * @method TablePress\Complex ln()
 * @method TablePress\Complex log2()
 * @method TablePress\Complex log10()
 * @method TablePress\Complex negative()
 * @method TablePress\Complex pow(int|float $power)
 * @method float rho()
 * @method TablePress\Complex sec()
 * @method TablePress\Complex sech()
 * @method TablePress\Complex sin()
 * @method TablePress\Complex sinh()
 * @method TablePress\Complex sqrt()
 * @method TablePress\Complex tan()
 * @method TablePress\Complex tanh()
 * @method float theta()
 * @method TablePress\Complex add(...$complexValues)
 * @method TablePress\Complex subtract(...$complexValues)
 * @method TablePress\Complex multiply(...$complexValues)
 * @method TablePress\Complex divideby(...$complexValues)
 * @method TablePress\Complex divideinto(...$complexValues)
 */
class Complex
{
	/**
	 ...
	 *
	 * @return    TablePress\Complex|float
	...
	public function __call($functionName, $arguments)
	{
		...
		throw new Exception('TablePress\Complex Function or Operation does not exist');
	}
}
