...
class PageSetup
{
	 ...
	 * @return $this
	 */
	public function setPaperSize(int $paperSize)
	{
	 ...
	 * @return $this
	 */
	public function setScale(?int $scale, bool $update = true)
	{
	 ...
	 * @return $this
	 */
	public function setFitToHeight(?int $fitToHeight, bool $update = true)
	{
	 ...
	 * @return $this
	 */
	public function setFitToWidth(?int $value, bool $update = true)
	{
	 ...
	 * @return $this
	 */
	public function setColumnsToRepeatAtLeftByStartAndEnd(string $start, string $end)
	{
	 ...
	 * @return $this
	 */
	public function setRowsToRepeatAtTopByStartAndEnd(int $start, int $end)
	{
	 ...
	 * @return $this
	 */
	public function setHorizontalCentered(bool $value)
	{
	 ...
	 * @return $this
	 */
	public function setVerticalCentered(bool $value)
	{
	 ...
	 * @return $this
	 */
	public function clearPrintArea(int $index = 0)
	{
		if ($index == 0) {
			$this->printArea = null;
		} else {
	 ...
	 * @return $this
	 */
	public function setPrintArea(string $value, int $index = 0, string $method = self::SETPRINTRANGE_OVERWRITE)
	{
	 ...
	 * @return $this
	 */
	public function addPrintArea(string $value, int $index = -1)
	{
	 ...
	 * @return $this
	 */
	public function setPrintAreaByColumnAndRow(int $column1, int $row1, int $column2, int $row2, int $index = 0, string $method = self::SETPRINTRANGE_OVERWRITE)
	{
	 ...
	 * @return $this
	 */
	public function addPrintAreaByColumnAndRow(int $column1, int $row1, int $column2, int $row2, int $index = -1)
	{
		return $this->setPrintArea(
			Coordinate::stringFromColumnIndex($column1) . $row1 . ':' . Coordinate::stringFromColumnIndex($column2) . $row2,
			$index,
	 ...
	 * @return $this
	 */
	public function setFirstPageNumber(?int $value)
	{
