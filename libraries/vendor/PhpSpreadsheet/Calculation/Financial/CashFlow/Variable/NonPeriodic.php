...
namespace TablePress\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Variable;
...
class NonPeriodic
{
	...
	/**
				 ...
				 * @param mixed $values A series of cash flows that corresponds to a schedule of payments in dates, expecting float[].
