...
class FormattedNumber
{
	 ...
	 */
	public static function convertToNumberIfFormatted(&$operand): bool
	{
	 ...
	 * @param float|string $operand string value to test
	 */
	public static function convertToNumberIfNumeric(&$operand): bool
	{
	 ...
	 * @param float|string $operand string value to test
	 */
	public static function convertToNumberIfPercent(&$operand): bool
	{
		$thousandsSeparator = preg_quote(StringHelper::getThousandsSeparator(), '/');
	 ...
	 * @param float|string $operand string value to test
	 */
	public static function convertToNumberIfCurrency(&$operand): bool
	{
