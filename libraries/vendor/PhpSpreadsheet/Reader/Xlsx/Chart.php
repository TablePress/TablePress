...
use TablePress\PhpOffice\PhpSpreadsheet\Chart\Axis;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\AxisText;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\ChartColor;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\DataSeries;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\DataTable;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\GridLines;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\Layout;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\Legend;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\PlotArea;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\Properties as ChartProperties;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\Title;
use TablePress\PhpOffice\PhpSpreadsheet\Chart\TrendLine;
...
class Chart
{
	...
	private static function getAttributeString(SimpleXMLElement $component, string $name): ?string
	{
	...
	private static function getAttributeInteger(SimpleXMLElement $component, string $name): ?int
	{
		$attributes = $component->attributes();
		if (@isset($attributes[$name])) {
	...
	private static function getAttributeBoolean(SimpleXMLElement $component, string $name): ?bool
	{
		$attributes = $component->attributes();
		if (@isset($attributes[$name])) {
	...
	private static function getAttributeFloat(SimpleXMLElement $component, string $name): ?float
	{
		$attributes = $component->attributes();
		if (@isset($attributes[$name])) {
	...
	public function readChart(SimpleXMLElement $chartElements, string $chartName): \TablePress\PhpOffice\PhpSpreadsheet\Chart\Chart
	{
		...
		$chart = new \TablePress\PhpOffice\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
		if ($chartNoFill) {
