...
class CurrencyBase extends Number
{
	 ...
	 *          ICU 72.1+.
	 * @param mixed $negative How to display negative numbers.
	 ...
	 * @param \TablePress\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Wizard\CurrencyNegative::* $negative
	 */
	public function __construct(
		...
		$negative = CurrencyNegative::minus
	) {
