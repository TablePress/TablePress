...
class DateFormatter
{
				...
				public static function format($value, string $format): string
	{
		...
		$format = Preg::replaceCallback('/(?:^|")([^"]*)(?:$|")/', \Closure::fromCallable([self::class, 'setLowerCaseCallback']), $format);
		...
		$format = Preg::replaceCallback('/"(.*)"/U', \Closure::fromCallable([self::class, 'escapeQuotesCallback']), $format);
