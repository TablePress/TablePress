...
class Alignment extends Supervisor
{
	 ...
	 *        [
	 *            'horizontal'   => \TablePress\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER,
	 *            'vertical'     => \TablePress\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER,
	 *            'textRotation' => 0,
	 *            'wrapText'     => TRUE
	 *        ]
	 * );
	 ...
	 * @return $this
	 */
	public function setJustifyLastLine(bool $justifyLastLine)
	{
		if ($this->isSupervisor) {
	 ...
	 * @return $this
	 */
	public function setVertical(string $verticalAlignment)
	{
	 ...
	 * @return $this
	 */
	public function setTextRotation(int $angleInDegrees)
	{
	 ...
	 * @return $this
	 */
	public function setWrapText(bool $wrapped)
	{
		if ($wrapped == '') {
			$wrapped = false;
		}
	 ...
	 * @return $this
	 */
	public function setShrinkToFit(bool $shrink)
	{
		if ($shrink == '') {
			$shrink = false;
		}
	 ...
	 * @return $this
	 */
	public function setReadOrder(int $readOrder)
	{
