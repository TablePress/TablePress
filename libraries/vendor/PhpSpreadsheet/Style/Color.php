...
use TablePress\PhpOffice\PhpSpreadsheet\Theme;
...
class Color extends Supervisor
{
	 ...
	 * @return $this
	 */
	public function setARGB(?string $colorValue = self::COLOR_BLACK, bool $nullStringOkay = false)
	{
	...
	{
		$rgb = ($nullsafeVariable1 = $this->getActiveSheet()
			->getParent()) ? $nullsafeVariable1->getTheme()->getThemeColors() : null;
