...
change_datatables_pagination:function(){var b=a("#option-datatables-paginate"),b=b.prop("checked")&&!b.prop("disabled");a("#option-datatables-lengthchange").prop("disabled",!b);a("#option-datatables-paginate_entries").prop("disabled",!b)},prepare_ajax_request:function(b,c){var d=a("#edit-form-body"),e=[],f,g={rows:tp.table.rows,columns:tp.table.columns,hidden_rows:0,hidden_columns:0},j={rows:[],columns:[]};d.children().each(function(b,c){e[b]=a(c).find("textarea").map(function(){return a(this).val()}).get()});
e=JSON.stringify(e);f={table_head:tp.table.head,table_foot:tp.table.foot,alternating_row_colors:a("#option-alternating-row-colors").prop("checked"),row_hover:a("#option-row-hover").prop("checked"),print_name:a("#option-print-name").prop("checked"),print_description:a("#option-print-description").prop("checked"),print_name_position:a("#option-print-name-position").val(),print_description_position:a("#option-print-description-position").val(),extra_css_classes:a("#option-extra-css-classes").val(),use_datatables:a("#option-use-datatables").prop("checked"),
datatables_sort:a("#option-datatables-sort").prop("checked"),datatables_filter:a("#option-datatables-filter").prop("checked"),datatables_paginate:a("#option-datatables-paginate").prop("checked"),datatables_lengthchange:a("#option-datatables-lengthchange").prop("checked"),datatables_paginate_entries:a("#option-datatables-paginate_entries").val(),datatables_info:a("#option-datatables-info").prop("checked"),datatables_scrollx:a("#option-datatables-scrollx").prop("checked"),datatables_custom_commands:a("#option-datatables-custom-commands").val()};
f=JSON.stringify(f);j.rows=d.find('input[type="hidden"]').map(function(){if("1"==a(this).val())return 1;g.hidden_rows+=1;return 0}).get();j.columns=a("#edit-form-foot").find('input[type="hidden"]').map(function(){if("1"==a(this).val())return 1;g.hidden_columns+=1;return 0}).get();j=JSON.stringify(j);return{action:b,_ajax_nonce:a(c).val(),tablepress:{id:tp.table.id,new_id:tp.table.new_id,name:a("#table-name").val(),description:a("#table-description").val(),number:g,data:e,options:f,visibility:j}}},
preview:{trigger:function(){if(!tp.made_changes)return tp.table.preview.show(a(this).attr("href")+"&TB_iframe=true"),!1;if(a("#option-datatables-paginate").prop("checked")&&!/^[1-9][0-9]{0,4}$/.test(a("#option-datatables-paginate_entries").val()))alert(tablepress_strings.num_pagination_entries_invalid),a("#option-datatables-paginate_entries").focus().select();else if(/[^A-Za-z0-9- _]/.test(a("#option-extra-css-classes").val()))alert(tablepress_strings.extra_css_classes_invalid),a("#option-extra-css-classes").focus().select();
else return a(this).closest("p").append('<span class="animation-preview spinner" title="'+tablepress_strings.preparing_preview+'"/>'),a("body").addClass("wait"),a("#table-preview").empty(),a.post(ajaxurl,tp.table.prepare_ajax_request("tablepress_preview_table","#nonce-preview-table"),function(){},"json").success(tp.table.preview.ajax_success).error(tp.table.preview.ajax_error),!1},ajax_success:function(a,c){"undefined"==typeof c||"success"!=c?tp.table.preview.error("AJAX call successful, but unclear status."):
...
a("body").removeClass("wait");tp.table.preview.show("#TB_inline?inlineId=preview-container")},error:function(b){a(".animation-preview").closest("p").after('<div class="preview-error error"><p><strong>'+tablepress_strings.preview_error+": "+b+"</strong></p></div>");a(".animation-preview").remove();a(".preview-error").delay(6E3).fadeOut(2E3,function(){a(this).remove()});a("body").removeClass("wait")},show:function(b){var c=a(window).width()-120,d=a(window).height()-120;a("body.admin-bar").length&&(d-=
28);tb_show(a(".show-preview-button").first().text(),b+"&height="+d+"&width="+c,!1)}}},rows:{create:function(b){var c,d,e,f="";for(c=0;c<b;c++){f+=tp.table.body_cells_pre;for(d=0;d<tp.table.columns;d++)f+=tp.table.body_cell;f+=tp.table.body_cells_post}e=a("#edit-form-foot").find(".column-hidden").map(function(){return a(this).index()}).get();return a(f).each(function(b,c){a(c).children().filter(function(b){return-1!=a.inArray(b,e)}).addClass("column-hidden")})},append:function(){var b=a("#rows-append-number").val();
/^[1-9][0-9]{0,4}$/.test(b)?(a("#edit-form-body").append(tp.rows.create(b)),tp.rows.stripe(),tp.reindex()):(alert(tablepress_strings.append_num_rows_invalid),a("#rows-append-number").focus().select())},insert:function(b){b=a("#edit-form-body").find("input:checked").prop("checked",b.shiftKey).closest("tr");0===b.length?alert(tablepress_strings.no_rows_selected):(b.before(tp.rows.create(1)),tp.rows.stripe(),tp.reindex())},duplicate:function(b){b=a("#edit-form-body").find("input:checked").prop("checked",
b.shiftKey).closest("tr");0===b.length?alert(tablepress_strings.no_rows_selected):(b.each(function(b,d){var e=a(d),f=e.find("textarea"),g=e.clone();g.find("textarea").removeAttr("id").each(function(b,c){a(c).val(f.eq(b).val())});e.after(g)}),tp.rows.stripe(),tp.reindex())},hide:function(b){b=a("#edit-form-body").find("input:checked").prop("checked",b.shiftKey).closest("tr");0===b.length?alert(tablepress_strings.no_rows_selected):(b.addClass("row-hidden").find(".visibility").val("0"),tp.rows.stripe(),
tp.table.set_table_changed())},unhide:function(b){b=a("#edit-form-body").find("input:checked").prop("checked",b.shiftKey).closest("tr");0===b.length?alert(tablepress_strings.no_rows_selected):(b.removeClass("row-hidden").find(".visibility").val("1"),tp.rows.stripe(),tp.table.set_table_changed())},remove:function(){var b,c=a("#edit-form-body").find("input:checked").closest("tr");0===c.length?alert(tablepress_strings.no_rows_selected):tp.table.rows==c.length?alert(tablepress_strings.no_remove_all_rows):
(b=1==c.length?tablepress_strings.ays_remove_rows_singular:tablepress_strings.ays_remove_rows_plural,confirm(b)&&(c.remove(),tp.rows.stripe(),tp.reindex()))},move:{start:function(b,c){a(c.placeholder).removeClass("row-hidden").css("visibility","visible").html('<td colspan="'+(tp.table.columns+tp.table.no_data_columns_pre+tp.table.no_data_columns_post)+'"><div/></td>');a(c.helper).removeClass("odd head-row foot-row")},change:function(a,c){tp.rows.stripe(c.helper)},stop:function(){tp.rows.stripe()}},
sort:function(){var b=a(this).parent().index(),c=a(this).hasClass("sort-asc")?1:-1,d=a("#edit-form-body"),e=d.find(".head-row").prevAll().addBack(),f=d.find(".foot-row").nextAll().addBack(),g=d.children().not(e).not(f).get(),j=function(a,b){var c=/(^-?[0-9]+(\.?[0-9]*)[df]?e?[0-9]?$|^0x[0-9a-f]+$|[0-9]+)/gi,d=/(^[ ]*|[ ]*$)/g,e=/(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/,f=/^0x[0-9a-f]+$/i,g=/^0/,h=a.replace(d,"")||"",j=b.replace(d,
"")||"",d=h.replace(c,"\x00$1\x00").replace(/\0$/,"").replace(/^\0/,"").split("\x00"),c=j.replace(c,"\x00$1\x00").replace(/\0$/,"").replace(/^\0/,"").split("\x00"),h=parseInt(h.match(f))||1!=d.length&&h.match(e)&&Date.parse(h);if(e=parseInt(j.match(f))||h&&j.match(e)&&Date.parse(j)||null){if(h<e)return-1;if(h>e)return 1}h=0;for(j=Math.max(d.length,c.length);h<j;h++){e=!(d[h]||"").match(g)&&parseFloat(d[h])||d[h]||0;f=!(c[h]||"").match(g)&&parseFloat(c[h])||c[h]||0;if(isNaN(e)!==isNaN(f))return isNaN(e)?
1:-1;typeof e!==typeof f&&(e+="",f+="");if(e<f)return-1;if(e>f)return 1}return 0};a.each(g,function(c,d){d.sort_key=(""+a(d).children().eq(b).find("textarea").val()).toLowerCase()});g.sort(function(a,b){return c*j(a.sort_key,b.sort_key)});a.each(g,function(a,b){b.sort_key=null});d.append(e);d.append(g);d.append(f);tp.rows.stripe();tp.reindex()},stripe:function(b){"undefined"==typeof b&&(b=null);b=a(b);var c=a("#edit-form-body").children().removeClass("odd head-row foot-row").not(b);c.filter(":even").addClass("odd");
c=c.not(".row-hidden");b.hasClass("row-hidden")&&(c=c.not(".ui-sortable-placeholder"));tp.table.head&&c.first().addClass("head-row");tp.table.foot&&c.last().addClass("foot-row")}},columns:{append:function(){var b,c=a("#columns-append-number").val(),d=new_head_cells=new_foot_cells="";if(/^[1-9][0-9]{0,4}$/.test(c)){for(b=0;b<c;b++)d+=tp.table.body_cell,new_head_cells+=tp.table.head_cell,new_foot_cells+=tp.table.foot_cell;a("#edit-form-body").children().each(function(b,c){a(c).children().slice(-tp.table.no_data_columns_post).before(d)});
...
a("#edit-form-body").children().each(function(b,e){a(e).children().filter(function(b){return-1!=a.inArray(b,c)}).before(tp.table.body_cell)}),a("#edit-form-head").children().filter(function(b){return-1!=a.inArray(b,c)}).before(tp.table.head_cell),b.before(tp.table.foot_cell),tp.reindex())},duplicate:function(b){var c;b=a("#edit-form-foot").find("input:checked").prop("checked",b.shiftKey).closest("th");0===b.length?alert(tablepress_strings.no_columns_selected):(c=b.map(function(){return a(this).index()}).get(),
a("#edit-form").find("tr").each(function(b,e){a(e).children().each(function(b,d){if(-1!=a.inArray(b,c)){var e=a(d),k=e.clone();k.find("textarea").removeAttr("id").val(e.find("textarea").val());e.after(k)}})}),tp.reindex())},hide:function(b){var c;b=a("#edit-form-foot").find("input:checked").prop("checked",b.shiftKey).closest("th");0===b.length?alert(tablepress_strings.no_columns_selected):(c=b.map(function(){return a(this).index()}).get(),a("#edit-form-body").children().add("#edit-form-head").each(function(b,
e){a(e).children().filter(function(b){return-1!=a.inArray(b,c)}).addClass("column-hidden")}),b.addClass("column-hidden").find(".visibility").val("0"),tp.table.set_table_changed())},unhide:function(b){var c;b=a("#edit-form-foot").find("input:checked").prop("checked",b.shiftKey).closest("th");0===b.length?alert(tablepress_strings.no_columns_selected):(c=b.map(function(){return a(this).index()}).get(),a("#edit-form-body").children().add("#edit-form-head").each(function(b,e){a(e).children().filter(function(b){return-1!=
a.inArray(b,c)}).removeClass("column-hidden")}),b.removeClass("column-hidden").find(".visibility").val("1"),tp.table.set_table_changed())},remove:function(){var b,c,d=a("#edit-form-foot").find("input:checked").closest("th");0===d.length?alert(tablepress_strings.no_columns_selected):tp.table.columns==d.length?alert(tablepress_strings.no_remove_all_columns):(c=1==d.length?tablepress_strings.ays_remove_columns_singular:tablepress_strings.ays_remove_columns_plural,confirm(c)&&(b=d.map(function(){return a(this).index()}).get(),
a("#edit-form-body").children().add("#edit-form-head").each(function(c,d){a(d).children().filter(function(c){return-1!=a.inArray(c,b)}).remove()}),d.remove(),tp.reindex()))},move:{source_idx:-1,target_idx:-1,$rows:null,$row_children:null,$cell:null,$cells:null,$placeholder:null,$helper:null,start:function(b,c){var d=a(c.item);tp.columns.move.source_idx=d.index();tp.columns.move.$rows=a("#edit-form-body").children().add("#edit-form-foot");tp.columns.move.$cells=tp.columns.move.$rows.find(":nth-child("+
(tp.columns.move.source_idx+1)+")").each(function(){tp.columns.move.$cell=a(this);a('<td class="move-placeholder"><div/></td>').insertBefore(tp.columns.move.$cell);tp.columns.move.$cell.insertAfter(tp.columns.move.$cell.nextAll().last()).clone().addClass("move-hover").insertAfter(tp.columns.move.$cell).find("textarea").val(tp.columns.move.$cell.find("textarea").val())}).hide();tp.columns.move.$helper=tp.columns.move.$rows.find(".move-hover");d=tp.columns.move.$helper.eq(1).width();tp.columns.move.$helper.eq(0).width(d);
tp.columns.move.$placeholder=tp.columns.move.$rows.find(".move-placeholder");tp.columns.move.$placeholder.find("div").width(d)},change:function(b,c){tp.columns.move.target_idx=a(c.placeholder).index();1==tp.columns.move.target_idx-tp.columns.move.source_idx?tp.columns.move.target_idx+=1:tp.columns.move.target_idx==tp.columns.move.source_idx&&(tp.columns.move.target_idx-=1);tp.columns.move.$placeholder.each(function(){tp.columns.move.$cell=a(this);tp.columns.move.$cell.insertBefore(tp.columns.move.$cell.parent().children().eq(tp.columns.move.target_idx))});
tp.columns.move.target_idx>tp.columns.move.source_idx&&(tp.columns.move.target_idx-=1);tp.columns.move.source_idx=tp.columns.move.target_idx},sort:function(a,c){tp.columns.move.$helper.css("left",c.position.left)},stop:function(){tp.columns.move.$helper.remove();tp.columns.move.$cells.each(function(){tp.columns.move.$cell=a(this);tp.columns.move.$cell.insertBefore(tp.columns.move.$cell.parent().find(".move-placeholder"))}).show();tp.columns.move.$placeholder.remove();tp.columns.move.source_idx=tp.columns.move.target_idx=
-1;tp.columns.move.$rows=tp.columns.move.$row_children=tp.columns.move.$cell=tp.columns.move.$cells=tp.columns.move.$placeholder=tp.columns.move.$helper=null;tp.reindex()}},number_to_letter:function(a){for(var c="";0<a;)c=String.fromCharCode(65+(a-1)%26)+c,a=Math.floor((a-1)/26);return c}},cells:{$focus:a(null),$textarea:null,autogrow:function(){tp.cells.$focus.removeClass("focus");tp.cells.$focus=a(this).closest("tr").addClass("focus")},advanced_editor:{keyopen:function(b){b.shiftKey&&(b=a("#advanced-editor-content"),
tp.cells.advanced_editor.thickbox_size(),tp.cells.$textarea=a(this).blur(),b.val(tp.cells.$textarea.val()),a("#advanced-editor").wpdialog("open"),b.get(0).selectionStart=b.get(0).selectionEnd=b.val().length,b.focus())},buttonopen:function(){if(confirm(tablepress_strings.advanced_editor_open))a("#edit-form-body").one("click","textarea",function(){var b=a("#advanced-editor-content");tp.cells.advanced_editor.thickbox_size();tp.cells.$textarea=a(this).blur();b.val(tp.cells.$textarea.val());a("#advanced-editor").wpdialog("open");
b.get(0).selectionStart=b.get(0).selectionEnd=b.val().length;b.focus()})},save:function(){var b=a("#advanced-editor-content").blur().val();tp.cells.$textarea.val()!=b&&(tp.cells.$textarea.val(b),tp.cells.$textarea.get(0).selectionStart=tp.cells.$textarea.get(0).selectionEnd=tp.cells.$textarea.val().length,tp.table.set_table_changed());tp.cells.$textarea.focus();tp.cells.advanced_editor.close()},close:function(){a("#advanced-editor").wpdialog("close");return!1},thickbox_size:function(){var b=a("#advanced-editor-content-add_media"),
c;c=a(window).width();var d=720<c?720:c,e=a(window).height();b.length&&(c=b.attr("href"),a("body.admin-bar").length&&(e-=28),c=c.replace(/&width=[0-9]+/g,"").replace(/&height=[0-9]+/g,""),b.attr("href",c+("&width="+(d-80)+"&height="+(e-85))))}},checkboxes:{last_clicked:{"#edit-form-body":!1,"#edit-form-foot":!1},multi_select:function(b){if("undefined"==b.shiftKey)return!0;if(b.shiftKey){if(!tp.cells.checkboxes.last_clicked[b.data.parent])return!0;var c=a(b.data.parent).find(":checkbox"),d=c.index(tp.cells.checkboxes.last_clicked[b.data.parent]),
e=c.index(this);d!=e&&c.slice(Math.min(d,e),Math.max(d,e)).prop("checked",a(this).prop("checked"))}tp.cells.checkboxes.last_clicked[b.data.parent]=this;return!0}}},content:{link:{add:function(){if(confirm(tablepress_strings.link_add))a("#edit-form-body").one("mousedown","textarea",function(){wpActiveEditor=this.id;a(document).one("mouseup",function(){wpLink.open();tp.table.set_table_changed()})})}},image:{add:function(){if(confirm(tablepress_strings.image_add))a("#edit-form-body").one("click","textarea",
function(){wpActiveEditor=this.id;this.selectionStart=this.selectionEnd=this.value.length;var b=a("#image-add"),c=a(window).width(),c=720<c?720:c,d=a(window).height();a("body.admin-bar").length&&(d-=28);tb_show(b.text(),b.attr("href")+"&TB_iframe=true&height="+(d-85)+"&width="+(c-80),!1);a(this).blur()});return!1}},span:{add:function(b){var c="#rowspan#"==b?tablepress_strings.rowspan_add:tablepress_strings.colspan_add;if(a("#option-use-datatables").prop("checked"))if(confirm(tablepress_strings.span_add_datatables_warning))a("#option-use-datatables").prop("checked",
!1).change();else return;if(confirm(c))a("#edit-form-body").one("click","textarea",function(){var c=a(this),e=c.parent().index(),f=c.closest("tr").index();if("#rowspan#"==b){if(0==f){alert(tablepress_strings.no_rowspan_first_row);return}if(tp.table.head&&1==f){alert(tablepress_strings.no_rowspan_table_head);return}if(tp.table.foot&&tp.table.rows-1==f){alert(tablepress_strings.no_rowspan_table_foot);return}}else if("#colspan#"==b&&tp.table.no_data_columns_pre==e){alert(tablepress_strings.no_colspan_first_col);
return}c.val(b);tp.table.set_table_changed()})}}},check:{table_id:function(b){37==b.which||39==b.which||(b=a(this),b.val(b.val().replace(/[^0-9a-zA-Z-_]/g,"")))},changes_saved:function(){if(tp.made_changes)return tablepress_strings.unsaved_changes_unload}},reindex:function(){var b,c=a("#edit-form-body").children(),d,e={};tp.table.rows=c.length;tp.table.columns=0<tp.table.rows?c.first().children().length-tp.table.no_data_columns_pre-tp.table.no_data_columns_post:0;c.each(function(c,g){b=a(g);b.find("textarea").val(function(b,
c){return""==c||"="!=c.charAt(0)?c:c.replace(/([A-Z]+[0-9]+)(?::([A-Z]+[0-9]+))?/g,function(b,c,f){e.hasOwnProperty(c)||(d=a("#cell-"+c),e[c]=d.length?tp.columns.number_to_letter(d.parent().index()-tp.table.no_data_columns_pre+1)+(d.closest("tr").index()+1):c);b=e[c];"undefined"!=typeof f&&""!=f&&(e.hasOwnProperty(f)||(d=a("#cell-"+f),e[f]=d.length?tp.columns.number_to_letter(d.parent().index()-tp.table.no_data_columns_pre+1)+(d.closest("tr").index()+1):f),b+=":"+e[f]);return b})}).attr("name",function(a){return"table[data]["+
c+"]["+a+"]"});b.find(".move-handle").html(c+1)}).each(function(b,c){a(c).find("textarea").attr("id",function(a){return"cell-"+tp.columns.number_to_letter(a+1)+(b+1)})});a("#edit-form-head").find(".move-handle").html(function(a){return tp.columns.number_to_letter(a+1)});a("#number-rows").val(tp.table.rows);a("#number-columns").val(tp.table.columns);tp.table.set_table_changed()},save_changes:{trigger:function(b){a("#option-datatables-paginate").prop("checked")&&!/^[1-9][0-9]{0,4}$/.test(a("#option-datatables-paginate_entries").val())?
