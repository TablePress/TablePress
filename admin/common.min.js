...
".delete-link",function(){if(!confirm(tablepress_common.ays_delete_single_table))return!1;"undefined"!=typeof tp&&(tp.made_changes=!1)});a("#tablepress-page").on("click",".table-shortcode",function(){a(this).focus().select()})});