...
abstract class TablePress {
	 ...
	 * @const string
	 */
	public const version = '3.2.4'; // phpcs:ignore Generic.NamingConventions.UpperCaseConstantName.ClassConstantNotUpperCase
	 ...
	 * @const int
	 */
	public const db_version = 118; // phpcs:ignore Generic.NamingConventions.UpperCaseConstantName.ClassConstantNotUpperCase
