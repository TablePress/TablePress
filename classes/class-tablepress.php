...
abstract class TablePress {
	 ...
	 * @const string
	 */
	public const version = '3.2.3'; // phpcs:ignore Generic.NamingConventions.UpperCaseConstantName.ClassConstantNotUpperCase
	 ...
	 * @const int
	 */
	public const db_version = 117; // phpcs:ignore Generic.NamingConventions.UpperCaseConstantName.ClassConstantNotUpperCase
