...
abstract class TablePress {
	 ...
	 * @const string
	 */
	public const version = '3.1.1'; // phpcs:ignore Generic.NamingConventions.UpperCaseConstantName.ClassConstantNotUpperCase
	 ...
	 * @const int
	 */
	public const db_version = 109; // phpcs:ignore Generic.NamingConventions.UpperCaseConstantName.ClassConstantNotUpperCase
